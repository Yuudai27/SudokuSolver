...
public class Board {
    ...
    public static void main(String[] args) {
        ...
        while(!layout.clearState()) {
            ...
            long timeStart = 0;
            while(inputError) {
                //Waiting until solve- button gets pressed.
            ...
            final int[][] fieldMatrixRow = {{3,6},{4,7},{5,8},{0,6},{1,7},{2,8},{0,3},{1,4},{2,5}};
            final int[][] fieldMatrixColumn = {{1,2},{0,2},{0,1},{4,5},{3,5},{3,4},{7,8},{6,8},{6,7}};
