...
public class Board {
	...
	public static void main(String[] args) {
		...
		for(int x = 0; x < 3; x++) {
			for(int y = 0; y < 3; y++) {
				if(sudokuBoard[x][y].fieldReady() == false){
					readyState = false;
					break;
				}
			}
				...
				if(doubleMarkersCt > 0) {
					...
					if(searchArray[0] != 9 && searchArray[1] != 9) {
						...
						//checking through the other field if there is a second time this double marker
							...
							if(sudokuBoard[fieldMatrixRow[fieldID][0]%3][fieldMatrixRow[fieldID][0]/3].checkDoubleMarksInRow(searchArray[0]%3,searchArray[2], searchArray[3]) == true) {
							...
							else if(sudokuBoard[fieldMatrixRow[fieldID][1]%3][fieldMatrixRow[fieldID][1]/3].checkDoubleMarksInRow(searchArray[0]%3,searchArray[2], searchArray[3]) == true){
							...
							if(sudokuBoard[fieldMatrixRow[fieldID][0]%3][fieldMatrixRow[fieldID][0]/3].checkDoubleMarksInRow(searchArray[1]%3,searchArray[2], searchArray[3]) == true) {
							...
							else if(sudokuBoard[fieldMatrixRow[fieldID][1]%3][fieldMatrixRow[fieldID][1]/3].checkDoubleMarksInRow(searchArray[1]%3,searchArray[2], searchArray[3]) == true) {
							...
							if(sudokuBoard[(fieldMatrixColumn[fieldID][0]%3)][(fieldMatrixColumn[fieldID][0]/3)].checkDoubleMarksInColumn(searchArray[0]/3,searchArray[2],searchArray[3])==true) {
							...
							else if(sudokuBoard[(fieldMatrixColumn[fieldID][1]%3)][(fieldMatrixColumn[fieldID][1]/3)].checkDoubleMarksInColumn(searchArray[0]/3,searchArray[2],searchArray[3]) == true){
							...
							if(sudokuBoard[(fieldMatrixColumn[fieldID][0]%3)][(fieldMatrixColumn[fieldID][0]/3)].checkDoubleMarksInColumn(searchArray[1]/3,searchArray[2],searchArray[3])==true) {
							...
							else if(sudokuBoard[(fieldMatrixColumn[fieldID][1]%3)][(fieldMatrixColumn[fieldID][1]/3)].checkDoubleMarksInColumn(searchArray[1]/3,searchArray[2],searchArray[3]) == true){
