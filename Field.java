...
public class Field {
	...
	private int[][] fieldNumbers = new int[3][3];						//array for holding the read values of the layout
	protected int[] sizeMarkers = new int[9];							//array for keeping the counts of possible numbers for each single field
	protected int[] checkedDouble = new int[9];							//array to log if a single field already got checked for double markers
	private ArrayList<ArrayList<Integer>> markers = new ArrayList<>(9);	//array list to hold the possible numbers for each single field
	 ...
	 * single fields.
	 * If this counters are equal, checkedDouble array will be reseted.
	 */
